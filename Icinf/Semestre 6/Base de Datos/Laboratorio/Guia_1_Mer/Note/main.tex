...
\linkDoc{https://github.com/MarceloPazPezo/MyRepo/blob/main/Icinf/Semestre\%206/Base\%20de\%20Datos/Laboratorio/Guia_1_Mer/Guia1MER.pdf}
...
\insertarfigura{img/Entidad.png}{2.5cm}{Entidad Persona con algunos atributos}
...
\insertarfigura{img/Relacion.png}{2.5cm}{Relacion entre Persona y una Empresa}
...
\insertarfigura{img/unoAMuchos.png}{3cm}{Relacion 1:M}
...
\insertarfigura{img/muchosAMuchos.png}{3cm}{Relacion N:M}
...
\insertarfigura{img/unoAUno.png}{3cm}{Relacion 1:1}
...
\insertarfigura{img/Herencia.png}{4.5cm}{Herencia}
...
\insertarfigura{img/Ejercicio1.png}{4cm}{MER 1}
...
\insertarfigura{img/Ejercicio2.png}{12cm}{MER 2}
...
\insertarfigura{img/Ejercicio3.png}{8cm}{MER 3}
...
\insertarfigura{img/Ejercicio4.png}{8cm}{MER 4}
...
\insertarfigura{img/Ejercicio5.png}{10cm}{MER 5}
...
% \insertarfigura{img/Ejercicio6.png}{4cm}{MER 6}
...
% en el mismo.
% \end{enumerate}
% \insertarfigura{img/Ejercicio7.png}{4cm}{MER 7}
