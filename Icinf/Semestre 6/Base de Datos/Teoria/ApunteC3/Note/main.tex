    ...
    \begin{enumerate}
        ...
        \begin{minipage}{0.4\textwidth}
            \begin{center}
                ...
                \begin{figure}[H]
                    \centering
                    \colorbox{green!20!white}{\includegraphics[scale=0.08]{img/FNBC.png}}
                \end{figure}
    ...
    \begin{figure}[H]
        \begin{center}
            ...
            \begin{tabular}{|c|c|c|}
                ...
                \tikzmarknode{d}{\textcolor{blue}{$R(x)$}} & & \\
                \tikzmarknode{e}{\textcolor{blue}{$W(x)$}} & & \\
                & \tikzmarknode{f}{\textcolor{green!80!black}{$W(x)$}} & \\ \hline
            \end{tabular}
            \begin{tikzpicture}[overlay, remember picture]
                ...
                \draw[->, shorten >=3pt, shorten <=3pt, line width=3pt, red] (e.east) -- (f.west);
            \end{tikzpicture}
        \end{center}
    \end{figure}
