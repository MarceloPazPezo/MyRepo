...
\linkDoc{https://github.com/MarceloPazPezo/MyRepo/blob/main/Icinf/Semestre\%206/Economia\%201/Certamen\%201/ApunteEconomia.pdf}
...
* $E$ = Expectativas.\\
    ...
    \newpage
    \item \textbf{Exceso de demanda:} Es la diferencia entre la cantidad demandada y la cantidad ofrecida.\\
    \begin{align*}
        {Q_x}^d - {Q_x}^s > 0
    \end{align*}
    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}
            ...
            \draw[color=red] (axis cs:4,2.2) node[above] {$+1$};

            \end{axis}
        \end{tikzpicture}
        \caption{Exceso de demanda}
        \begin{align*}
            {Q_x}^d - {Q_x}^s &= 1
        \end{align*}
    \end{figure}

    \item \textbf{Exceso de oferta:} Es la diferencia entre la cantidad ofrecida y la cantidad demandada.\\
    \begin{align*}
        {Q_x}^s - {Q_x}^d > 0
    \end{align*}
    \begin{figure}[H]
        ...
        \begin{tikzpicture}
            ...
            \draw[color=green] (axis cs:4,4.6) node[above] {$+1$};

            \end{axis}
        \end{tikzpicture}
        \caption{Exceso de oferta}
        \begin{align*}
            {Q_x}^s - {Q_x}^d &= 1
        \end{align*}
    \end{figure}
