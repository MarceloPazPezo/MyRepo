...
\begin{align*}
    Y &= 100 - \frac{3}{5}X \\
    \\
    max_{X} (10X \cdot (100 - \frac{3}{5}X)) &= 1000X - 30 {X}^2 \\
    \\
    \frac{\mathrm{d} U(X)}{\mathrm{d}X} &= 1000 - 60X = 0 \Leftrightarrow {X}^* = 16,667 \\
    \\
    {Y}^* &= 100 - \frac{3}{5} \times 16,667 \\
    &= 90 \\
    \\
    \therefore \quad U({X}^*, {Y}^*) &= 10(16,667 \times 90) \\
    &= 15000,3
\end{align*}
