...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.4]{diagram/ProblemaTransporte.png}
\end{figure}
Donde:
\begin{itemize}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.4]{diagram/ModeloLineal.png}
\end{figure}
\begin{equation*}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.4]{diagram/RestriccionesOferta.png}
\end{figure}
\begin{align*}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.4]{diagram/RestriccionesDemanda.png}
\end{figure}
\begin{align*}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.4]{diagram/PTE1.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.33]{diagram/PTE1B.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.29]{diagram/PTE2.png}
\end{figure}
\begin{itemize}
    \item $m = 3$
    \item $n = 4$
