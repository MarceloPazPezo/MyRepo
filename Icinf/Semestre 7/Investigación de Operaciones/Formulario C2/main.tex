...
\linkQRDoc{https://github.com/MarceloPazPezo/MyRepo/blob/main/Icinf/Semestre\%207/Investigaci\%C3\%B3n\%20de\%20Operaciones/Formulario\%20C2/Formulario-C2.pdf}
...
\begin{tcolorbox}[
    ...
    title=\textbf{M/M/1} $\rho < 1$, % Título de la caja
]
...
\begin{tcolorbox}[
    ...
    colback=white!100,       % Color del fondo
    coltitle=white!100, % Color del título
    title=\textbf{M/M/S} $\rho < 1$, % Título de la caja
]
\begin{minipage}{0.15\textwidth}
    \begin{equation*}
