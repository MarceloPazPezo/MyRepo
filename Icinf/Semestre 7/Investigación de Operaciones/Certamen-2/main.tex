...
\begin{center}
    \includegraphics[width=0.5\textwidth]{diagram/Aperiodico.png}
\end{center}
\subsubsection{Recurrentes: Periodico}
\begin{center}
    \includegraphics[width=0.65\textwidth]{diagram/Periodico.png}
\end{center}
...
\begin{itemize}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.4\textwidth]{diagram/DTEDist.png}
    \end{figure}
    \begin{equation*}
        A, A, B, B, C, A, A, C, A, B
    \end{equation*}
